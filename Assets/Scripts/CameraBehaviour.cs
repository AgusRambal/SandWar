...
public class CameraBehaviour : MonoBehaviour
{
    ...
    [SerializeField] private float zoomOffsetMin;
    [SerializeField] private float zoomOffsetMax;
    ...
    private void UseDragPan()
    {
        ...
        {
            Vector2 mouseMovenetDelta = (Vector2)Input.mousePosition - lastMousePosition;

            inputDir.x = mouseMovenetDelta.x * panSpeed;
            inputDir.z = mouseMovenetDelta.y * panSpeed;

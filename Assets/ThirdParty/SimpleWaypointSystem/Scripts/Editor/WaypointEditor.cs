...
namespace SWS
{
    ...
    public class WaypointEditor : Editor
    {
        ...
        //workaround bug 1394023 in <= Unity 2022.1
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            //draw instructions
            GUILayout.TextArea("Hint:\nEnter a unique name for your path, then press 'Start Path' to begin placement mode. " + 
                               "Press '" + script.placementKey + "' on your keyboard to place new waypoints in the Scene view. " + 
                               "If you have multiple SceneViews open, you might need to right-click in one to select it. " +
                               "\n\nIn 3D Mode you have to place waypoints onto game objects with colliders. You can also place " +
                               "waypoints at the current scene view camera position by pressing '" + script.viewPlacementKey + "'." +
